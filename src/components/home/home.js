        ...
        <div className="homeContainer">
            ...
            <div className="banner">
                ...
                <p className="userWelcome">
                    ...
                    <span className="first-line">Queremos agradecerte por haberte tomado el tiempo de haber llegado</span> <br/> a este punto, y apoyar con tu compra a las familias cafeteras del CAUCA
                    </p>
                </p>
                </div>
